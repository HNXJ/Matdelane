...
xlabel("Bsl-AFR");ylabel("Oxm-AFR");
legend;

fname = "1E-Scatter-Ox-Bl-Cluster";
print(gcf,'-vector','-dsvg', fname +".svg");
...
fname = "2E-Scatter-Ox-St-PEV-Cluster";
print(gcf,'-vector','-dsvg', fname +".svg");
...
for iA = 1:11
    ...
    [p, h, ~] = ranksum(xrks{1, iA}, xrks{2, iA}, 'tail', 'right');
