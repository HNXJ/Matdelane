...
%% Ses: sub-C31o_ses-230630 (Probes A,B,C)

%% Probe A (PFC, laminar)

%% E.0: Load NWB

nwbFile = nwbPath + nwbFiles{1};
nwb = nwbRead(nwbFile);
...
channel_in_layer.deep = 30:128;
channel_in_layer.mid = 25:29;
channel_in_layer.sup = [1:17, 19:24];
...
%% Probe B (MT, It seems to be majorly MT due to strong gamma response)

%% E.1: Load LFP probeB  MT
...
channel_in_layer = struct();
channel_in_layer.deep = 1:76;
channel_in_layer.mid = 77:87;
channel_in_layer.sup = 88:125;
...
%% Probe C (V1, It seems that it consists only of one area, to be identified, highly foveal)
...
channel_in_layer.deep = [39:2:71, 75:2:121];
channel_in_layer.mid = 31:2:37;
channel_in_layer.sup = [11:18, 19:2:30];
goodch = [channel_in_layer.sup, channel_in_layer.mid, channel_in_layer.deep];
