...
q1.jMUAplot(9:12, [-500 4000], 300, 1);
...
q1 = load("OGLOobj\sub-C31o_ses-230825PFC.mat", "obj").obj;

%% E4.3: Save TFR separately

tfrpath = "tfrData\";
tfrname = "230825PFC.mat";
tfrx = q1.pgx;
...
tfrpath = "tfrData\";
tfrname = "230825MT.mat";
tfrx = q2.pgx;
save(tfrpath + tfrname, "tfrx", "-v7.3");

tfrpath = "tfrData\";
tfrname = "230825MST.mat";
tfrx = q2.pgx2;
save(tfrpath + tfrname, "tfrx", "-v7.3");
...
q3 = load("OGLOobj\sub-C31o_ses-230825V4-TEO.mat", "obj").obj;

%% E4.3: Save TFR separately

tfrpath = "tfrData\";
tfrname = "230825V4.mat";
tfrx = q3.pgx;
save(tfrpath + tfrname, "tfrx", "-v7.3");

tfrpath = "tfrData\";
tfrname = "230825TEO.mat";
tfrx = q3.pgx2;
save(tfrpath + tfrname, "tfrx", "-v7.3");
