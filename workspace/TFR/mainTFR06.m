...
q1.jTFRplot(10, 4, q1.tbands{1}(end-9:end));
...
q2 = jnwb(nwbFile, "MT/", 500, 4250, 1, 0);
...
channel_in_layer.mid = 67:2:74;
channel_in_layer.deep = 75:2:128;
...
q3 = jnwb(nwbFile, "V1-V3d/", 500, 4250, 2, 0);
