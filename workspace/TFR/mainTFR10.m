...
supch_s16_v3d = 1:30;
midch_s16_v3d = 31:36;
deepch_s16_v3d = 37:64;

deepch_s16_v3a = 65:90;
midch_s16_v3a = 91:101;
supch_s16_v3a = 102:128;

goodch_v3d = [supch_s16_v3d, midch_s16_v3d, deepch_s16_v3d];
goodch_v3a = [deepch_s16_v3a, midch_s16_v3a, supch_s16_v3a];
...
for ik = [2, 6]
    ...
    xG1d = squeeze(mean(x{ik}(:, deepch_s16_v3d, :), 2));
    xG1m = squeeze(mean(x{ik}(:, midch_s16_v3d, :), 2));
    xG1s = squeeze(mean(x{ik}(:, supch_s16_v3d, :), 2));
