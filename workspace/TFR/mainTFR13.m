...
channel_in_layer2.deep = 58:90;
channel_in_layer2.mid = 90:95;
channel_in_layer2.sup = 96:105;
...
q1 = load("OGLOobj\sub-V198o_ses-230714V1-V2.mat", "obj").obj;

%% E4.3: Save TFR separately

tfrpath = "tfrData\";
tfrname = "230714V1.mat";
tfrx = q1.pgx;
save(tfrpath + tfrname, "tfrx", "-v7.3");

tfrpath = "tfrData\";
tfrname = "230714V2.mat";
tfrx = q1.pgx2;
save(tfrpath + tfrname, "tfrx", "-v7.3");
...
q2 = load("OGLOobj\sub-V198o_ses-230714V3d-V3a.mat", "obj").obj;

%% E4.3: Save TFR separately

tfrpath = "tfrData\";
tfrname = "230714V3d.mat";
tfrx = q2.pgx;
save(tfrpath + tfrname, "tfrx", "-v7.3");

tfrpath = "tfrData\";
tfrname = "230714V3a.mat";
tfrx = q2.pgx2;
save(tfrpath + tfrname, "tfrx", "-v7.3");
